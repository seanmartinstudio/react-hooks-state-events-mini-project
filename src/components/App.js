...
const filteredItems = tasks.filter(task => category === "All" || task.category === category)
  ...
  return (
    <div className="App">
      ...
      <NewTaskForm categories={CATEGORIES} taskFormInput={taskFormInput} setTaskFormInput={setTaskFormInput} 
      tasks={tasks} setTasks={setTasks} formCategory={formCategory} setFormCategory={setFormCategory}/>
